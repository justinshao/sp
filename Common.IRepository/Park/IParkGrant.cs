...
namespace Common.IRepository.Park
{
    public interface IParkGrant
    {
        ...
        bool Update(string grantId, ParkGrantState state, DbOperator dbOperator);
        ...
        bool RestoreUse(string grantId, DateTime beginDate, DateTime endDate, DbOperator dbOperator);
