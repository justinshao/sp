...
namespace Common.Services.Park
{
    public class ParkMonthlyCarApplyServices
    {
        ...
        private static BaseEmployee GenerateBaseEmployeeModel(string villageId, string employeeName, string mobilePhone, string familyAddr)
        {
        ...
        private static EmployeePlate GenerateEmployeePlateModel(BaseEmployee employee, string villageId, string plateNo)
        {
        ...
        private static BaseCard GenerateCardModel(BaseParkinfo parking, BaseEmployee employee, EmployeePlate plate, string loginUserRecordId)
        {
        ...
        private static ParkGrant GenerateParkGrantModel(BaseParkinfo parking, EmployeePlate plate, BaseCard card, string pkLot, string carModelId, string carTypeId, string AreaIDS, string GateID)
        {
