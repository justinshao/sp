...
namespace PlatformServers
{
    ...
    public partial class MainWindow : Window
    {
            ...
            try
            {
                if (assembly.Type == AssemblyType.ServiceAssembly)
                {
                    ...
                    foreach (Type type in assembly.Assembly.GetTypes())
                    {
                        ...
                        ThreadServiceHost threadServiceHost = assembly.ServiceHosts.Single(h => h.ServiceName == name);
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //SystemInfo.ZXAddr = OptionHelper.ReadString("CenterServer", "ZXAddr", "");
            ...
            ServicesDLL.ClearData.StartClear();
        ...
        private void TestDBConnectionState()
        {
            Action<bool> connState = (iscon) =>
            {
                if (iscon)
                {
                    dbconnection.Source = new BitmapImage(new Uri("/Proxy-Data;component/Images/Device_Online.png", UriKind.Relative));
                }
                else
                {
                    dbconnection.Source = new BitmapImage(new Uri("/Proxy-Data;component/Images/Device_Offline.png", UriKind.Relative));
                }
            };
