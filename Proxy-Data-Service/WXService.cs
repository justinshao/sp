...
namespace PlatformWcfServers
{
    ...
    public class WXService
    {
        ...
        /// 日志记录对象
        /// </summary>
        protected Logger logger = LogManager.GetLogger("微信操作");
        ...
        public bool RegisterAccount(string strwxinfo)
        {
            ...
            lock (objlock)
            {
                    ...
                    using (DbOperator dbOperator = ConnectionManager.CreateReadConnection())
                    {
                        ...
                        using (DbDataReader reader = dbOperator.ExecuteReader(strsql.ToString()))
                        {
                            if (reader.Read())
                            {
                                ...
                                {
                                    logger.Fatal("修改用户信息出错！RegisterAccount()" + "\r\n");
                                    return false;
                                }
                            }
                            else
                            {
                                ...
                                if (dbOperator.ExecuteNonQuery(strsql) <= 0)
                                {
                                    logger.Fatal("增加用户信息出错！RegisterAccount()" + "\r\n");
                                    dbOperator.RollbackTransaction();
                                    return false;
                                }
                ...
                {
                    logger.Fatal("关注微信号异常：RegisterAccount()" + ex.Message + "\r\n");
                    return false;
                }
        ...
        public bool WXBindingMobilePhone(string AccountID, string MobilePhone)
        {
            ...
            lock (objlock)
            {
                    ...
                    using (DbOperator dbOperator = ConnectionManager.CreateReadConnection())
                    {
                        ...
                        using (DbDataReader reader = dbOperator.ExecuteReader(strsql.ToString()))
                        {
                            if (reader.Read())
                            {
                                ...
                                {
                                    dbOperator.RollbackTransaction();
                                    logger.Fatal("绑定手机号码修改账号手机信息失败！WXBindingMobilePhone()\r\n");
                                    return false;
                                }
                ...
                {
                    logger.Fatal("绑定手机号码出错！WXBindingMobilePhone()" + ex.Message + "\r\n");
                }
            }
            return false;
        }
        ...
        public bool WXUnsubscribe(string OpenID)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("修改微信状态异常：EditWXState()" + ex.Message + "\r\n");
                    return false;
                }
            }
        }
        ...
        public string QueryWXByOpenId(string OpenID)
        {
            ...
            {
                logger.Fatal("获取账户微信信息异常：QueryAccountByOpenId()" + ex.Message + "\r\n");
                return "";
            }
        }
        ...
        public bool EditWXInfo(string wx_info)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("修改微信信息异常：EditWXInfo()" + ex.Message + "\r\n");
                    return false;
                }
            }
        }
        ...
        public string QueryAccountByAccountID(string AccountID)
        {
            ...
            {
                logger.Fatal("获取账户信息异常：QueryAccountByAccountID()" + ex.Message + "\r\n");
                return "";
            }
        }
        ...
        public string QueryAccountByMobilePhone(string MobilePhone)
        {
            ...
            {
                logger.Fatal("获取账户信息异常：QueryAccountByMobilePhone()" + ex.Message + "\r\n");
                return "";
            }
        }
        ...
        public bool EditAccountOption(string wx_account)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("修改微信设置信息异常：EditAccountOption()" + ex.Message + "\r\n");
                    return false;
                }
            }
        }
        ...
        public bool EidtWX_infoVisitDate(string OpenID)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("修改微信最后访问时间异常：EidtWX_infoVisitDate()" + ex.Message + "\r\n");
                    return false;
                }
            }
        }
        ...
        public bool EidtWX_infoLastPlateNumber(string OpenID, string LastPlateNumber)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("修改最后一次缴费车牌号码异常：EidtWX_infoLastPlateNumber()" + ex.Message + "\r\n");
                    return false;
                }
            }
        }
        ...
        public string GetPkparkinfoList(double currX, double currY, int Leng)
        {
            ...
            {
                logger.Fatal("获取车场信息失败！GetPkparkinfoList()" + ex.StackTrace + "\r\n");
            }
        ...
        public string GetPkparkinByAccountIDList(string AccountID)
        {
            ...
            {
                logger.Fatal("获取车场信息失败！GetPkparkinByAccountIDList()" + ex.StackTrace + "\r\n");
            }
        ...
        public int AddWX_CarInfo(string CarInfo)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("增加车辆信息异常：AddWX_CarInfo()" + ex.Message + "\r\n");
                    return 2;
                }
            }
        }
        ...
        public bool DelWX_CarInfo(string RecordID)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("删除车辆信息异常：DelWX_CarInfo()" + ex.Message + "\r\n");
                    return false;
                }
            }
        ...
        public string GetCarInfoByAccountID(string AccountID)
        {
            ...
            {
                logger.Fatal("根据账户ID获取车辆信息异常：GetCarInfoByAccountID()" + ex.Message + "\r\n");
                return "";
            }
        }
        ...
        public List<string> GetTempCarInfoIn(string AccountID)
        {
            ...
            {
                logger.Fatal("根据账户ID获取在场临停车辆异常：GetTempCarInfoIn()" + ex.Message + "\r\n");
                return list;
            }
        ...
        public string GetMonthCarInfoByAccountID(string AccountID)
        {
            ...
            {
                logger.Fatal("根据账户ID获取长期卡信息异常：GetMonthCarInfoByAccountID()" + ex.Message + "\r\n");
                return "";
            }
        }
        ...
        public string GetMonthCarInfoByPlateNumber(string PlateNumber)
        {
            ...
            {
                logger.Fatal("根据车牌号码获取长期卡信息异常：GetMonthCarInfoByPlateNumber()" + ex.Message + "\r\n");
                return "";
            }
        }
        ...
        public string GetBaseParkinfoByPKID(string PKID)
        {
            ...
            {
                logger.Fatal("根据车场ID获取车场信息异常：GetBaseParkinfoByPKID()" + ex.Message + "\r\n");
                return "";
            }
        ...
        public string GetLockCarByAccountID(string AccountID)
        {
            ...
            {
                logger.Fatal("获取车辆锁车解锁状态异常：GetLockCarByAccountID()" + ex.Message + "\r\n");
                return "";
            }
        }
                        ...
                        using (DbDataReader reader = dbOperator.ExecuteReader(strsql.ToString()))
                        {
                            if (reader.Read())
                            {
                                if (reader["IsBoxWatch"].ToBoolean())
                                {
                                    ...
                                    return callback.LockCarInfo(AccountID, PKID, PlateNumber, reader["VID"].ToString());
                                }
                                else
                                {
                                    WXServiceCallback callback = new WXServiceCallback();
                                    return callback.LockCarInfo(AccountID, PKID, PlateNumber, reader["ProxyNo"].ToString());
                                }
                            }
                        }
                    }
                    ...
                    using (DbOperator dbOperator = ConnectionManager.CreateReadConnection())
                    {
                        ...
                        using (DbDataReader reader = dbOperator.ExecuteReader(strsql.ToString()))
                        {
                            if (reader.Read())
                            {
                                ...
                                {
                                    WXBoxServiceCallback callback = new WXBoxServiceCallback();
                                    return callback.UlockCarInfo(AccountID, PKID, PlateNumber, reader["VID"].ToString());
                                }
                                else
                                {
                                    WXServiceCallback callback = new WXServiceCallback();
                                    return callback.UlockCarInfo(AccountID, PKID, PlateNumber, reader["ProxyNo"].ToString());
                                }
                            }
                        }
                    }
        ...
        public int OrderWhetherEffective(string OrderNo)
        {
            ...
            {
                logger.Fatal("判断订单是否有效异常：OrderWhetherEffective()" + ex.Message + "\r\n");
                return 3;
            }
        }
        ...
        public string WXMonthlyRenewals(string CardID, string PKID, int MonthNum, decimal Amount, string AccountID, int PayWay, int OrderSource, string OnlineOrderID, DateTime PayDate)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("月租车辆续期异常：MonthlyRenewals()" + ex.Message + "\r\n");
                    result.Result = APPResult.OtherException;
                    return JsonHelper.GetJsonString(result);
                }
            }
        ...
        public string WXTempParkingFee(string PlateNumber, string PKID, DateTime CalculatDate, string AccountID, int OrderSource)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("获取临停费用异常：WXTempParkingFee()" + ex.Message + "\r\n");
                    result.Result = APPResult.OtherException;
                    return JsonHelper.GetJsonString(result);
                }
            }
        ...
        public string WXTempStopPayment(string OrderID, int PayWay, decimal Amount, string PKID, string OnlineOrderID, string AccountID, DateTime PayDate)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("临时卡缴费异常：WXTempStopPayment()" + ex.Message + "\r\n");
                    result.Result = APPResult.OtherException;
                    return JsonHelper.GetJsonString(result);
                }
            }
        ...
        public string WXScanCodeTempParkingFee(string BoxID, string AccountID, int OrderSource)
        {
            ...
            lock (objlock)
            {
                ...
                {
                    logger.Fatal("获取临停费用异常：WXScanCodeTempParkingFee()" + ex.Message + "\r\n");
                    result.Result = APPResult.OtherException;
                    return JsonHelper.GetJsonString(result);
                }
            }
        ...
        public string WXScanCodeTempParkingFeeByGateID(string GateID, string AccountID, int OrderSource)
        {
            ...
            lock (objlock)
            {
                try
                {
                    logger.Fatal(string.Format("获取临时卡费用异常：WXScanCodeTempParkingFeeByGateID,GateID：{0},AccountID：{1},OrderSource：{2}", GateID, AccountID, OrderSource));
                    using (DbOperator dbOperator = ConnectionManager.CreateReadConnection())
                    {
                        string strsql = "";
                ...
                {
                    logger.Fatal("获取临停费用异常：WXScanCodeTempParkingFeeByGateID()" + ex.Message + "\r\n");
                    result.Result = APPResult.OtherException;
                    return JsonHelper.GetJsonString(result);
                }
            }
        ...
        public string GetPkOrderTempByAccountID(string AccountID)
        {
            ...
            {
                logger.Fatal("根据账户ID获取临停缴费纪录异常：GetPkOrderTempByAccountID()" + ex.Message + "\r\n");
                return "";
            }
        ...
        public string GetPkOrderMonthByAccountID(string AccountID)
        {
            ...
            {
                logger.Fatal("根据账户ID获取月卡续期纪录异常：GetPkOrderMonthByAccountID()" + ex.Message + "\r\n");
                return "";
            }
        }
        #endregion
        ...
        public string WXGetParkDerate(string sellerID, string VID, string ProxyNo)
        {
            ...
            {
                logger.Fatal("获取商户打折信息异常：WXGetParkDerate()" + ex.Message + "\r\n");
            }
        ...
        public string WXGetIORecordByPlateNumber(string PlateNumber, string VID, string SellerID, string ProxyNo)
        {
            ...
            {
                logger.Fatal("获取车牌进场信息异常：WXGetPKIORecordByPlateNumber()" + ex.Message + "\r\n");
            }
        ...
        public string WXDiscountPlateNumber(string IORecordID, string DerateID, string VID, string SellerID, decimal DerateMoney, string ProxyNo)
        {
            ...
            {
                logger.Fatal("消费打折异常：WXDiscountPlateNumber()" + ex.Message + "\r\n");
            }
        ...
        public string WXGetSellerInfo(string SellerNo, string PWD, string SellerID, string ProxyNo)
        {
            ...
            {
                logger.Fatal("获取商户信息异常：WXGetSellerInfo()" + ex.Message + "\r\n");
            }
        ...
        public string WXGetParkCarDerate(string parms, int rows, int pageindex, string ProxyNo)
        {
            ...
            {
                logger.Fatal("获取商家打折详情异常：WXGetParkCarDerate()" + ex.Message + "\r\n");
                return null;
            }
        ...
        public string WXGetParkCarDerateByVID(string parms, int rows, int pageindex, string ProxyNo)
        {
            ...
            {
                logger.Fatal("获取商家打折详情异常：WXGetParkCarDerateByVID()" + ex.Message + "\r\n");
                return null;
            }
        }
        #endregion
        ...
        #region 中心缴费
        //public string CentreCalculation(string PKID)
        //{
        ...
        public int WXScanCodeInOut(string PKID, string GateNo, string OpenId)
        {
            ...
            {
                logger.Fatal("扫码出入场异常：WXScanCodeInOut()" + ex.Message + "\r\n");
            }
            return 1002;
        }
        #endregion
        ...
        public string AddParkVisitor(string jsondata)
        {
            ...
            {
                logger.Fatal("增加访客信息异常：AddParkVisitor()" + ex.Message + "\r\n");
            }
            return "0";
        }
        ...
        public int WXRemoteGate(string UserID, string PKID, string GateID, string Remark)
        {
            ...
            catch (Exception ex)
            {
                ...
                logger.Fatal("远程开闸异常：WXRemoteGate()" + ex.Message + "\r\n");
            }
            return 3;
        }
        #endregion
        ...
        public string WXReservePKBit(string AccountID, string BitNo, string parking_id, string AreaID, string license_plate, DateTime start_time, DateTime end_time)
        {
            ...
            catch (Exception ex)
            {
                ...
                logger.Fatal("车位预定异常：WXReservePKBit()" + ex.Message + "\r\n");
            }
            return JsonHelper.GetJsonString(result);
        }
        ...
        public bool WXReserveBitPay(string ReserveID, string OrderID, decimal Amount, string PKID, string OnlineOrderID)
        {
            ...
            catch (Exception ex)
            {
                ...
                logger.Fatal("预约支付异常：WXReserveBitPay()" + ex.Message + "\r\n");
            }
            return false;
        }
        ...
        public string WXGetReservePKBit(string AccountID)
        {
            ...
            catch (Exception ex)
            {
                ...
                logger.Fatal("根据账号获取预定信息异常：WXGetReservePKBit()" + ex.Message + "\r\n");
            }
            return JsonHelper.GetJsonString(list);
        }
        #endregion
