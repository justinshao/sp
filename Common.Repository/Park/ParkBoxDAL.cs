    ...
    public class ParkBoxDAL : BaseDAL,IParkBox
    {
        public bool Add(ParkBox model)
        {
            using (DbOperator dbOperator = ConnectionManager.CreateConnection())
            {
                ...
                strSql.Append("insert into ParkBox(BoxID,BoxNo,BoxName,ComputerIP,AreaID,Remark,DataStatus,HaveUpdate,LastUpdateTime,IsCenterPayment,IsOnLine,ProxyNo)");
                strSql.Append(" values(@BoxID,@BoxNo,@BoxName,@ComputerIP,@AreaID,@Remark,@DataStatus,@HaveUpdate,@LastUpdateTime,@IsCenterPayment,@IsOnLine,@ProxyNo)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from ParkBox where BoxID=@BoxID and DataStatus!=@DataStatus");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from ParkBox where ComputerIP=@ComputerIP and DataStatus!=@DataStatus");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from ParkBox where AreaID=@AreaID and DataStatus!=@DataStatus");
            using (DbOperator dbOperator = ConnectionManager.CreateReadConnection())
            {
                dbOperator.ClearParameters();
