    ...
    public class ParkSellerDAL : BaseDAL, IParkSeller
    {
        ...
        public bool ModifySeller(ParkSeller model, out string errorMsg)
        {
            ...
            try
            {
                using (DbOperator dbOperator = ConnectionManager.CreateConnection())
                {
                    ...
                    StringBuilder strSql = new StringBuilder();
                    strSql.Append(@"update ParkSeller set Addr=@Addr,Balance=@Balance,Creditline=@Creditline,HaveUpdate=@HaveUpdate, LastUpdateTime=@LastUpdateTime,SellerName=@SellerName,VID=@VID");
        ...
        public bool Add(ParkSeller model)
        {
            using (DbOperator dbOperator = ConnectionManager.CreateConnection())
            {
                ...
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into ParkSeller(SellerID,SellerNo,SellerName,PWD,VID,Addr,Creditline,Balance,LastUpdateTime,HaveUpdate,DataStatus)");
                strSql.Append(" values(@SellerID,@SellerNo,@SellerName,@PWD,@VID,@Addr,@Creditline,@Balance,@LastUpdateTime,@HaveUpdate,@DataStatus)");
                dbOperator.ClearParameters();
                dbOperator.AddParameter("SellerID", model.SellerID);
