...
namespace PlatformWcfServers
{
    ...
    public class ClientDownDataService
    {
        ...
        /// 日志记录对象
        /// </summary>
        protected Logger logger = LogManager.GetLogger("主动下载数据");
        ...
        public string DownServiceData(string cmd, string ProxyNo)
        {
            ...
            {
                logger.Fatal("监控端主动拉取平台数据异常！DownServiceData()" + ex.Message + "\r\n", ex);
            }
        ...
        public string GetTableCount(string ProxyNo, string StrTable)
        {
            ...
            {
                logger.Fatal("监控端主动拉取平台表数据数量异常！GetTableCount()" + ex.Message + "\r\n");
            }
            if (string.IsNullOrEmpty(VID))
            {
                return jsondata;
        ...
        public string DownBaseCard(string VID)
        {
            ...
            {
                logger.Fatal("主动下载卡片信息信息异常！DownBaseCard()" + ex + "\r\n");
            }
        ...
        public string DownBaseCard(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载卡片信息信息异常page！DownBaseCard()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseCompany(string VID)
        {
            ...
            {
                logger.Fatal("主动下载公司信息异常！DownBaseCompany()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseCompany(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载公司信息异常Page！DownBaseCompany()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseEmployee(string VID)
        {
            ...
            {
                logger.Fatal("主动下载住户信息异常！DownBaseEmployee()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseEmployee(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载住户信息异常Page！DownBaseEmployee()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseParkinfo(string VID)
        {
            ...
            {
                logger.Fatal("主动下载车场信息异常！DownBaseParkinfo()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseParkinfo(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载车场信息异常Page！DownBaseParkinfo()" + ex.Message + "\r\n");
            }
        ...
        public string DownBasePassRemark(string VID)
        {
            ...
            {
                logger.Fatal("主动下载车场放行备注信息异常！DownBasePassRemark()" + ex.Message + "\r\n");
            }
        ...
        public string DownBasePassRemark(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载车场放行备注信息异常Page！DownBasePassRemark()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseVillage(string VID)
        {
            ...
            {
                logger.Fatal("主动下载小区信息异常！DownBaseVillage()" + ex.Message + "\r\n");
            }
        ...
        public string DownBaseVillage(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载小区信息异常Page！DownBaseVillage()" + ex.Message + "\r\n");
            }
        ...
        public string DownEmployeePlate(string VID)
        {
            ...
            {
                logger.Fatal("主动下载住户车牌信息异常！DownEmployeePlate()" + ex.Message + "\r\n");
            }
        ...
        public string DownEmployeePlate(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载住户车牌信息异常Page！DownEmployeePlate()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkArea(string VID)
        {
            ...
            {
                logger.Fatal("主动下载停车区域信息异常！DownParkArea()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkArea(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载停车区域信息异常Page！DownParkArea()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkBlacklist(string VID)
        {
            ...
            {
                logger.Fatal("主动下载车场黑名单信息异常Page！DownParkBlacklist()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkBox(string VID)
        {
            ...
            {
                logger.Fatal("主动下载岗亭信息异常！DownParkBox()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkBox(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载岗亭信息异常Page！DownParkBox()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkCardSuspendPlan(string VID)
        {
            ...
            {
                logger.Fatal("主动下载卡片暂停信息异常！DownParkCardSuspendPlan()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkCardSuspendPlan(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载卡片暂停信息异常Page！DownParkCardSuspendPlan()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkCarModel(string VID)
        {
            ...
            {
                logger.Fatal("主动下载车型信息异常！DownParkCarModel()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkCarModel(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载车型信息异常Page！DownParkCarModel()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkCarType(string VID)
        {
            ...
            {
                logger.Fatal("主动下载车类型信息异常！DownParkCarType()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkCarType(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载车类型信息异常Page！DownParkCarType()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkDerate(string VID)
        {
            ...
            {
                logger.Fatal("主动下载打折方式信息异常！DownParkDerate()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkDerate(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载打折方式信息异常Page！DownParkDerate()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkDevice(string VID)
        {
            ...
            {
                logger.Fatal("主动下载设备信息异常！DownParkDevice()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkDevice(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载设备信息异常Page！DownParkDevice()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkDeviceParam(string VID)
        {
            ...
            {
                logger.Fatal("主动下载设备参数信息异常！DownParkDeviceParam()" + ex.Message + "\r\n");
            }
            return strlist;
        }
        ...
        public string DownParkDeviceParam(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载设备参数信息异常Page！DownParkDeviceParam()" + ex.Message + "\r\n");
            }
            return strlist;
        }
        ...
        public string DownParkFeeRule(string VID)
        {
            ...
            {
                logger.Fatal("主动下载收费规则信息异常！DownParkFeeRule()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkFeeRule(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载收费规则信息异常Page！DownParkFeeRule()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkFeeRuleDetail(string VID)
        {
            ...
            {
                logger.Fatal("主动下载收费规则明细信息异常！DownParkFeeRuleDetail()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkFeeRuleDetail(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载收费规则明细信息异常Page！DownParkFeeRuleDetail()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkGate(string VID)
        {
            ...
            {
                logger.Fatal("主动下载通道信息异常！DownParkGate()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkGate(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载通道信息异常Page！DownParkGate()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkGrant(string VID)
        {
            ...
            {
                logger.Fatal("主动下载授权信息异常！DownParkGrant()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkGrant(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载授权信息异常Page！DownParkGrant()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkSeller(string VID)
        {
            ...
            {
                logger.Fatal("主动下载商户信息异常！DownParkSeller()" + ex.Message + "\r\n");
            }
        ...
        public string DownParkSeller(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载商户信息异常Page！DownParkSeller()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysRoleAuthorize(string VID)
        {
            ...
            {
                logger.Fatal("主动下载角色授权信息异常！DownSysRoleAuthorize()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysRoleAuthorize(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载角色授权信息异常Page！DownSysRoleAuthorize()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysRoles(string VID)
        {
            ...
            {
                logger.Fatal("主动下载角色信息异常！DownSysRoles()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysRoles(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载角色信息异常Page！DownSysRoles()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysScope(string VID)
        {
            ...
            {
                logger.Fatal("主动下载作用域信息异常！DownSysScope()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysScope(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载作用域信息异常Page！DownSysScope()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysScopeAuthorize(string VID)
        {
            ...
            {
                logger.Fatal("主动下载作用域对应的小区异常！DownSysScopeAuthorize()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysScopeAuthorize(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载作用域对应的小区异常Page！DownSysScopeAuthorize()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysUser(string VID)
        {
            ...
            {
                logger.Fatal("主动下载登陆用户信息异常！DownSysUser()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysUser(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载登陆用户信息异常Page！DownSysUser()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysUserRolesMapping(string VID)
        {
            ...
            {
                logger.Fatal("主动下载用户对应角色信息异常！DownSysUserRolesMapping()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysUserRolesMapping(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载用户对应角色信息异常Page！DownSysUserRolesMapping()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysUserScopeMapping(string VID)
        {
            ...
            {
                logger.Fatal("主动下载用户对应作用域信息异常！DownSysUserScopeMapping()" + ex.Message + "\r\n");
            }
        ...
        public string DownSysUserScopeMapping(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载用户对应作用域信息异常Page！DownSysUserScopeMapping()" + ex.Message + "\r\n");
            }
        ...
        public string DowLoadParkIORecord(string VID, int PageIndex)
        {
            ...
            {
                logger.Fatal("主动下载在场记录信息异常Page！DowLoadParkIORecord()" + ex.Message + "\r\n");
            }
