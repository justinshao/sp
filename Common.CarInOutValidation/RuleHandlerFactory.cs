...
namespace Common.CarInOutValidation
{
    ...
    class RuleHandlerFactory
    {
        ...
        /// 通道能否使用
        /// </summary>
        RuleHandler gateCanUseHandler = new GateCanUseHandler();
        ...
        { 
            gateCanUseHandler.SetNextRuleHandler(monthRuleHandler);//通道进出验证  
        ...
        {
            gateCanUseHandler.SetNextRuleHandler(monthOutRuleHandler);//通道进出验证  
        ...
        {
            gateCanUseHandler.SetNextRuleHandler(tempRuleHandler);//通道进出验证  
        ...
        {
            gateCanUseHandler.SetNextRuleHandler(tempOutRuleHandler);//通道进出验证  
        ...
        {
            gateCanUseHandler.SetNextRuleHandler(valueInRuleHandler);//通道进出验证  
        ...
        {
            gateCanUseHandler.SetNextRuleHandler(valueOutRuleHandler);//通道进出验证  
        ...
        {
            gateCanUseHandler.SetNextRuleHandler(vIPInRuleHandler);//通道进出验证  
        ...
        {
            gateCanUseHandler.SetNextRuleHandler(vIPOutRuleHandler);//通道进出验证  
